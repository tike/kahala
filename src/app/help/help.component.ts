...
export class HelpComponent implements OnInit {
  ...
  rules :string[] = [
    ...
    'A player moves by choosing one of their fields (that has 2 or more stones) and a direction to move in.',
    ...
    'At this point, the player can also steal the stones from the opponent\'s adjacent field, if the position is located in the inner row of the board.',
